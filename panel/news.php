              ...
              <table class="table table-striped ">
                ...
                <tbody>
                  <tr>
                    ...
                    <td> <?=  $new['news_date'] ?> </td>
                    <td> <img src="<?=  $new['news_picture'] ?>" alt=""  height="50px"> </td>
                    <td> <?=  $new['news_author'] ?> </td>
                    <td> <a href="delete.php?id=<?=$new['news_id'];?>" class="btn btn-danger">حذف</a> <a href="edit_news.php?id=<?=$new['news_id'];?>" class="btn btn-primary"> ویرایش</a> </td>
                  </tr>
