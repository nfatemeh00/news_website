...
$select = $conn->prepare("SELECT * FROM categories WHERE category_id=? ");
...
if (isset($_POST['sub'])) {
    ...
    $result = $conn->prepare("UPDATE categories SET category_name=? WHERE category_id=?");
        ...
        <nav
            ...
            <div class="container">
                <a class="navbar-brand" href="#">
                    <img src="images/logo.png" alt="news logo" width="50" />
                ...
                <div class="card card-primary bg-light shadow p-4 mt-5">
                    ...
                    <form action="#" class="mt-4" method="POST">
                        <?php foreach ($categories as $category): ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name" class="text-gray-600 fw-bold">نام دسته بندی</label>
                                    <input name="name" id="name" type="text" class="form-control mt-2" value="<?= $category['category_name'] ?>" />
                                </div>
