...
if (isset($_POST['sub'])) {
    ...
    $result = $conn->prepare("UPDATE users SET user_name=?, user_email=? WHERE user_id=?");
...
<section
            x-cloak
            class="sidebar bg-light transition" :class="open || 'inactive'">
            <div
            ...
            <div class="mt-4">
                <ul class="list-unstyled">
                    ...
                    <li x-data="dropdown" class="sidebar-item">
                        ...
                        <ul x-show="open" x-transition class="submenu">
                            <li class="submenu-item">
                                <a href="users.php">لیست ادمین ها</a>
                            </li>
                            <li class="submenu-item">
                                <a href="#">ایجاد ادمین</a>
                            </li>
                            <li class="submenu-item">
                                <a href="edit_user.php">ویرایش ادمین</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="card card-primary bg-light shadow p-4 mt-5">
                    ...
                    <form action="#" class="mt-4" method="POST">
                        <?php foreach ($users as $user): ?>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="name" class="text-gray-600 fw-bold">نام ادمین </label>
                                    <input name="name" id="name" type="text" class="form-control mt-2" value="<?= $user['user_name'] ?>" />
                                    <label for="name" class="text-gray-600 fw-bold">ایمیل  </label>
                                    <input name="email" id="name" type="text" class="form-control mt-2" value="<?= $user['user_email'] ?>" />
                                </div>
