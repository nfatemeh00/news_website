              ...
              <table class="table table-striped ">
                ...
                <tbody>
                  <tr>
                    ...
                    <th> <?=  $user['user_name'] ?> </td>
                    <td> <?=  $user['user_email'] ?> </td>
                    <td> <a href="delete_user.php?id=<?=$user['user_id'];?>" class="btn btn-danger">حذف</a> <a href="edit_user.php?id=<?=$user['user_id'];?>" class="btn btn-primary"> ویرایش</a> </td>
                  </tr>
