...
if(isset($_POST['sub'])){
  ...
  $result=$conn->prepare("INSERT INTO news SET news_title=?, news_date=? ,news_content=?, news_author=?, news_picture=?");
              ...
              <div class="row mt-4">
                <div class="col-md-6">
                  ...
                  <select name="writer" class="form-select mt-2" id="category">
                    <option value="1"> ادمین 1</option>
                    <option value=""> 2 ادمین</option>
                    <option value=""> ادمین 3</option>
                    <option value="">ادمین 4</option>
                    <option value="">ادمین 5</option>
                    <option value="">ادمین 6</option>
                  </select>
                </div>
