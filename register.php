    ...
    && isset($_POST['confirm']) && $_POST['confirm']!==''){
        if($_POST['password'] == $_POST['confirm']){
            if(strlen($_POST['password'])>4){
                    ...
                    $result = $conn->prepare("INSERT INTO users SET user_name=? ,user_email=? ,user_password=?");
            ...
            $error="رمز عبور با تاییده یکی نیست";
        }
    ...
    <section class="d-flex justify-content-center align-items-center min-h-screen bg">
        ...
        <div class="form-container">
            <form action="#"  method="POST" >
                ...
                <h1 class="title">ثبت نام  به عنوان نویسنده </h1>
                <div class="mt-3 position-relative">
                    <input name="username" type="" class="field" placeholder="  نام کاربری ... "..>
